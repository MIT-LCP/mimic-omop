...
-- CREATE INDEX chartevents_1_idx01 ON chartevents (itemid);
--
-- -- index on subject_id --
--
-- drop index IF EXISTS chartevents_1_idx02;
-- CREATE INDEX chartevents_1_idx02 ON chartevents (SUBJECT_ID);
--
-- -- index on hadm_id --
--
-- drop index IF EXISTS chartevents_1_idx04;
-- CREATE INDEX chartevents_1_idx04 ON chartevents (HADM_ID);
--
--
-- -- index on icustay_id --
--
-- drop index IF EXISTS chartevents_1_idx06;
-- CREATE INDEX chartevents_1_idx06 ON chartevents (ICUSTAY_ID);
